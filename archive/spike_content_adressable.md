...
> **Status: adopted 2026-07-19** — folded into [design.md](design.md), which is now the
> source of truth (the open questions in §9 carried over there as §14). This document is
> kept as the historical record of the git-workflow discussion of 2026-07-14 that
> developed the model. Findings referenced as A1/A3/… are in [review.md](review.md).
